...
namespace AttendanceSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260625023336_AddShortHours")]
    partial class AddShortHours
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.AttendanceRecord", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("EmployeeId", "Date"), new[] { "Status", "CheckInTime", "CheckOutTime" });
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.AuditLog", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("EntityId", "Action"), new[] { "CreatedAt", "PerformedBy" });
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.LeaveRequest", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("EmployeeId", "Status"), new[] { "StartDate", "EndDate", "LeaveType" });
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.WorkSchedule", b =>
                {
                    ...
                    b.ToTable("WorkSchedules", t =>
                        {
                            t.HasCheckConstraint("CHK_WorkDays_Range", "[WorkDays] BETWEEN 0 AND 127");
                        });
                });
