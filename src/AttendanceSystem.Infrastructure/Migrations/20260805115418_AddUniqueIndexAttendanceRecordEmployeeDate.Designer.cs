...
namespace AttendanceSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260805115418_AddUniqueIndexAttendanceRecordEmployeeDate")]
    partial class AddUniqueIndexAttendanceRecordEmployeeDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.TaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.TaskItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("WorkShiftPlanId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("WorkShiftPlanId");
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.WorkShiftPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkShiftPlans", (string)null);
                });
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasOne("AttendanceSystem.Domain.Entities.Permission", null)
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.TaskComment", b =>
                {
                    b.HasOne("AttendanceSystem.Domain.Entities.TaskItem", "TaskItem")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Entities.TaskItem", b =>
                {
                    b.HasOne("AttendanceSystem.Domain.Entities.WorkShiftPlan", "WorkShiftPlan")
                        .WithMany("TaskItems")
                        .HasForeignKey("WorkShiftPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WorkShiftPlan");
                });
