        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultWorkScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LateMinutes = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsManualEntry = table.Column<bool>(type: "bit", nullable: false),
                    IsSuspicious = table.Column<bool>(type: "bit", nullable: false),
                    IsAutoGeo = table.Column<bool>(type: "bit", nullable: false),
                    VerificationMethod = table.Column<int>(type: "int", nullable: false),
                    CheckInPhotoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CheckOutPhotoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    IsBirthdayLeave = table.Column<bool>(type: "bit", nullable: false),
                    ApprovedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuspiciousActivityAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuspiciousActivityAlerts_AttendanceRecords_AttendanceRecordId",
                        column: x => x.AttendanceRecordId,
                        principalTable: "AttendanceRecords",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SuspiciousActivityAlerts_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeAdjustmentRequests_AttendanceRecords_AttendanceRecordId",
                        column: x => x.AttendanceRecordId,
                        principalTable: "AttendanceRecords",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuspiciousActivityAlerts_AttendanceRecordId",
                table: "SuspiciousActivityAlerts",
                column: "AttendanceRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_SuspiciousActivityAlerts_EmployeeId",
                table: "SuspiciousActivityAlerts",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeAdjustmentRequests_AttendanceRecordId",
