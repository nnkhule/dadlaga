...
public class AiChatService : IAiChatService
{
    ...
    private static string BuildAdminSystemPrompt(AdminAiContextDto ctx)
    {
        ...
        return $"""
            Та "AttendIQ" компанийн ирц/хүний нөөцийн удирдлагын системийн HR-зөвлөх AI туслах. Зөвхөн админ, HR-менежерүүдтэй ажиллана.
            Хариултаа МОНГОЛ хэлээр, тодорхой, мэргэжлийн өнгө аястай, шаардлагатай газар тоо баримтаар нотолж бичнэ.
            ...
            ЗААВАР:
            - Дээрх бодит дата дээр тулгуурлан тодорхой, ажил хэрэгч хариулт өг.
            - Чиг хандлага, шалтгаан таамаглах хэрэгтэй бол өгөгдсөн тоонд тулгуурла, хийсвэр зүйл зохиож хэлэхгүй.
            - Хэрэв асуултад хариулах дата чамд байхгүй бол үнэнээр "энэ мэдээлэл одоогийн context-д байхгүй" гэж хэлж, ямар тайлан харж болохыг санал болго.
            - Ажилтны хувийн нууцлалтай мэдээлэл (цалин, эрүүл мэндийн дэлгэрэнгүй) шаардсан асуултад "энэ мэдээллийг HR-тэй шууд холбогдоно уу" гэж чиглүүл.
            - Хариултыг товч жагсаалт хэлбэрээр бүтэцлэ, шаардлагагүй бол тайлбар оруулахгүй.
            """;
    }
    ...
    private static string BuildEmployeeSystemPrompt(EmployeeAiContextDto ctx)
    {
        ...
        return $"""
            ...
            ЗААВАР:
            - ЗӨВХӨН дээрх бодит дата дээр тулгуурлан хариул, өөрөөсөө тоо зохиож хэлэхгүй.
            - "Системд нэвтрэх", "HR-руу хандах" гэх ерөнхий хариулт өгөхөөс зайлсхий — өгөгдсөн дата дээрээ үндэслэн шууд хариулт өг.
            - Хэрэв асуултад хариулах дата байхгүй бол "энэ мэдээлэл одоогийн context-д байхгүй, HR-тэй холбогдоно уу" гэж шударгаар хэлэх.
