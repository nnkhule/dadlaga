...
namespace AttendanceSystem.API.Controllers
{
    ...
    public sealed class EmployeesApiController : ControllerBase
    {
        ...
        /// <summary>
        /// Жагсаалт — хайлт, хэлтэс, төлөв (active/inactive), pagination дэмждег.
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// Soft delete — ажилтныг идэвхүй болгоно (IsActive = false).
        ...
        public async Task<IActionResult> Deactivate(Guid id, CancellationToken cancellationToken)
        {
            ...
            if (!employee.IsActive)
                return Ok(new { message = "Ажилтан өмнөй идэвхүй болсон байна." });

            employee.Deactivate();
            await _db.SaveChangesAsync(cancellationToken);

            return Ok(new { message = "Ажилтныг идэвхүй болгосон." });
        }

        /// <summary>
        /// Идэвхүй болгосон ажилтныг дахин идэвхжүүлэх.
        /// </summary>
